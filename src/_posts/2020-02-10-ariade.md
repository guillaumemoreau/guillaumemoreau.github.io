...
The ARIADE project (Augmented Reality for Improving Autonomy in DEmentia) headed by Mélanie Cogné from Rennes CHU (University Hospital) and INRIA Hybrid team has been funded by the INCR (Institut des Neurosciences Cliniques de Rennes). We will able to hire a postdoc who will work on setting up and assessing augmented reality aids for patients with neurodegenerative diseases.
